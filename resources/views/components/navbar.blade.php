<nav class="bg-gray-800/50" x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        ...
                        <div x-show="isOpen" x-cloak x-transition:enter="transition ease-out duration-300"
                            ...
                            class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-gray-800 py-1 shadow-lg ring-1 ring-black/5 focus:outline-none outline-1 -outline-offset-1 outline-white/10">
                            <a href="#"
            ...
            <div class="-mr-2 flex md:hidden">
                <!-- Mobile menu button -->
                <button @click="isOpen = !isOpen" @click.outside="isOpen = false" type="button" command="--toggle"
    ...
    <div x-show="isOpen" id="mobile-menu" class="block md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <!-- Current: "bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
            <x-nav-link href="/" :active="request()->is('/')">Home</x-nav-link>
            <x-nav-link href="/posts" :active="request()->is('postsposts')">posts</x-nav-link>
            <x-nav-link href="/about" :active="request()->is('about')">about</x-nav-link>
            <x-nav-link href="/contact" :active="request()->is('contact')">contact</x-nav-link>
        </div>
